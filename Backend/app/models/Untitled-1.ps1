...
$siteurl = Read-Host 'http://sp.sagacious.pk/sites/admin/'  
$username = Read-Host "User Name"  
$password = Read-Host -AsSecureString 'Password'   
   
if ($siteurl -eq '') {  
    $siteurl = 'http://sp.sagacious.pk/sites/admin/'  
    $username = 'sg\raheel.bashir'  
    $password = ConvertTo-SecureString -String 'Lahore@76543'`  
                -AsPlainText -Force  
}  
