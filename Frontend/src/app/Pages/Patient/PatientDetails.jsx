  ...
  const updatePatient = async () => {
    try {
      const updateUser = await axios.put(
        process.env.REACT_APP_ORIGIN_URL + `api/patients/${data.id}`,
        {
          id: data.id,
                  ...
                  <div className="col-xl-2 col-lg-2 col-sm-2 border p-3">
                    <Select
                      ...
                      value={City.getCitiesOfState(
                        ...
                        ).filter((f) => f.name == selectedState)[0]
                          ?.countryCode,
                        State?.getStatesOfCountry(
                          Country.getAllCountries().filter(
                            (f) => f.name == selectedCountry
                ...
                <div className="row" style={{ marginTop: "2rem" }}>
                  ...
                  <div className="col-xl-2 col-lg-2 col-sm-2 border p-3">
                    <Input
                      ...
                      value={data.emergency_person_relation}
                      onChange={handleInput}
                      disabled={disableFields}
                      sx={{
                        "& .MuiInputBase-input.Mui-disabled": {
                  ...
                  <div className="col-xl-2 col-lg-2 col-sm-2 border p-3">
                    <Input
                      ...
                      value={data.emergency_person_mobile}
                      onInput={(e) => {
                        e.target.value = Math.max(0, parseInt(e.target.value))
                          .toString()
                          .slice(0, 11);
                  ...
                  <div className="col-xl-6 col-lg-6 col-sm-6 border p-3">
                    <div style={{ marginLeft: "0rem" }}>
                      ...
                      <Form.Select
                        ...
                        class="form-control dropdown"
                        value={data.physiotherapist_seen_before}
                        onChange={handleInput}
                        disabled={disableFields}
                        sx={{
                          "& .MuiInputBase-input.Mui-disabled": {
          ...
          <>
            <div className="card" style={{ borderTopLeftRadius: "0" }}>
              <div className="card-body">
                <div style={{ display: "flex" }}>
                  <div>Name:</div>
                  <div style={{ color: "green", marginLeft: "0.3rem" }}>
                    {data.first_name}
                  </div>
                </div>
                <StyledTable>
