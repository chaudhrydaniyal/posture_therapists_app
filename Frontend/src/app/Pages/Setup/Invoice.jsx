...
const Invoice = () => {
  ...
  return (
    ...
    <ReactToPrint
              trigger={() => <Button color="primary" variant="contained" >Print</Button>}
    ...
    <div style={{display:'flex',justifyContent:'flex-end'}}>
        ...
        {/* <strong>Date: &nbsp;{currentDate}</strong><br></br> */}
    ...
    <strong >Sub total:<span style={{marginLeft:'0.5rem',alignItems:'flex-end'}}>{`PKR ${subtotal}`}</span></strong><br></br><br></br>
        {/* <strong>Date: &nbsp;{currentDate}</strong><br></br> */}
        <strong style={{marginLeft:'0'}}> Discount %: <span style={{marginLeft:'0.5rem',justifyContent:'end',alignItems:'end'}}>{`${invoiceDetails.state.discount}%`}</span></strong><br></br><br></br>
        <strong>Discount PKR:<span style={{marginLeft:'0.5rem'}}>{`PKR ${discount}`}</span></strong><br></br><br></br>
        <strong>Total Amount:<span style={{marginLeft:'0.5rem'}}>{`PKR ${total}`}</span></strong>
        
            
		 
		</div>
    </div>
		{/* <div className="total" style={{marginRight:'1rem'}}>

<div>
      <strong >Sub total:<span style={{marginLeft:'0.5rem'}}>{`PKR ${subtotal}`}</span></strong><br></br><br></br>
      </div><br></br>
      <div>
			<strong style={{marginLeft:'0'}}> Discount %: <span style={{marginLeft:'0.5rem'}}>{`${invoiceDetails.state.discount}%`}</span></strong><br></br><br></br>
      </div>
      <div>
      <strong>Discount PKR:<span style={{marginLeft:'0.5rem'}}>{`PKR ${discount}`}</span></strong><br></br><br></br>
      </div>
