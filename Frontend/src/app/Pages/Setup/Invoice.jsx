          ...
          <div className="container">
            <div className="header">
              ...
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div>
                  ...
                  <p>
                    <strong>Email:</strong> posture@company.com
                  </p>
                </div>
            ...
            <div style={{ display: "flex", justifyContent: "flex-end" }}>
              <div className="bill-to">
                <strong>
                  Sub total:
                  <span
                    style={{ marginLeft: "0.5rem", alignItems: "flex-end" }}
                  >{`PKR ${subtotal}`}</span>
                </strong>
                <br></br>
                <br></br>
                ...
                <strong style={{ marginLeft: "0" }}>
                  {invoiceDetails.state.discount
                    ? `Discount (${invoiceDetails.state.discount}%): PKR ${discount} `
                    : "Discount (0%): PKR 0"}
                </strong>
                <br></br>
                <br></br>
            ...
            <div style={{ display: "flex", justifyContent: "center" }}>
              ...
              <strong style={{ marginLeft: "0.5rem" }}>
                {" "}
                {total
                  ? `${total && numberToEnglish(total)}`
                  : `${subtotal && numberToEnglish(subtotal)}`}
              </strong>
            </div>
          </div>
        </div>
